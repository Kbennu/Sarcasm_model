...
1. **sarcasm_app/** — файлы для работы сервиса.
        - script.py — запуск приложения.
        - requirements.txt — зависимости проекта.
        - **HybridModel_ht/** — обученная модель.
        - **HybridTokenizer/** — токенизатор.
        - README.md
        - sarcasm_app — образ контейнера Podman
        - Dockerfile
2. **model/** — файлы для разработки и обучения модели.
...
## **12. Заключение**
Проект представляет собой завершённое решение для классификации текстовых заголовков на основе сарказма. 
Он включает этапы предобработки данных, обучения модели и создания сервиса для использования. 
Репозиторий организован таким образом, чтобы облегчить доработку и масштабирование проекта.
